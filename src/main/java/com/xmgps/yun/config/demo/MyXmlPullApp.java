...
/**
 * Created by huangwb on 2015/5/19.
 */
public class MyXmlPullApp
{
    ...
    public final static String SAMPLE_XML =
            "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                    "<Request>\n" +
                    "<TaskId>4028805f2abd2d2a012abdfc674a00f4</TaskId>\n" +
                    "<SenderId>" +
                    "XM.GOV.SQ.RS.DS.XXHC    " +
                    "</SenderId>\n" +
                    "<ServiceId>XM.GOV.YZ.DS.XXHC</ServiceId>\n" +
                    "<Inputs>\n" +
                    "  <Input name=\"SenderID\" type=\"string\">11</Input>\n" +
                    "  <Input name=\"ServiceID\" type=\"string\">IN_10000141</Input>\n" +
                    "  <Input name=\"DataObjectCode\" type=\"string\">A001</Input>\n" +
                    "  <Input name=\"Condition\" type=\"string\">xm='张刚'</Input>\n" +
                    "</Inputs>\n" +
                    "</Request>\n";
